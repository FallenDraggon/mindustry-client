...
//        if(player.isBuilder()){
    ...
    public void update(){
        ...
        if(input.keyTap(Binding.hide_fog) && scene.getKeyboardFocus() == null){
            Vars.state.rules.fog = !Vars.state.rules.fog;
            hidingFog = Vars.state.rules.fog;
        }
        ...
        if(input.keyTap(Binding.sniper_mode) && scene.getKeyboardFocus() == null){
